...
function PortalPage() {
  return (
    <div>
      <PageHeader title="Captive Portal" description="Customize what users see when they connect to the WiFi." />
      <div className="grid gap-4 p-6 lg:grid-cols-5">
        <div className="space-y-4 lg:col-span-3">
          <Panel title="Branding">
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <Label className="text-xs uppercase tracking-wider text-muted-foreground">Network name</Label>
              ...
              <div className="md:col-span-2">
                <Label className="text-xs uppercase tracking-wider text-muted-foreground">Welcome message</Label>
                <Textarea defaultValue="Welcome! Sign in or top up your wallet to get connected." className="mt-1.5" rows={3} />
              </div>
              <div className="md:col-span-2">
                <Label className="text-xs uppercase tracking-wider text-muted-foreground">Terms URL</Label>
          ...
          <Panel title="Authentication methods">
            {[
              { k: "MAC auto-login", v: true, desc: "Skip portal if MAC has active wallet balance" },
              { k: "Voucher code", v: true, desc: "Accept prepaid voucher codes" },
              { k: "M-Pesa STK push", v: true, desc: "On-portal mobile money payment" },
              { k: "Watch ad to unlock", v: false, desc: "Free 5-minute pass after viewing video ad" },
          ...
          <Panel title="MikroTik integration">
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <Label className="text-xs uppercase tracking-wider text-muted-foreground">Hotspot host</Label>
                <Input defaultValue="hotspot.meshgrid.local" className="mt-1.5 font-mono" />
              </div>
              <div>
                <Label className="text-xs uppercase tracking-wider text-muted-foreground">RADIUS shared secret</Label>
                <Input type="password" defaultValue="****************" className="mt-1.5 font-mono" />
              </div>
              <div>
                <Label className="text-xs uppercase tracking-wider text-muted-foreground">API port</Label>
            ...
            <div className="overflow-hidden rounded-lg border border-border bg-background">
              <div className="bg-card p-4">
                <div className="mx-auto max-w-xs space-y-3 text-center">
                  ...
                  <p className="text-xs text-muted-foreground">Welcome! Sign in or top up your wallet to get connected.</p>
                  <div className="space-y-2 pt-2">
                    <Button size="sm" className="w-full">Top up with M-Pesa</Button>
                    <Button size="sm" variant="outline" className="w-full">Enter voucher code</Button>
                  </div>
                  ...
                  <p className="text-[10px] text-muted-foreground">MAC: A4:5E:60:xx:xx:01 · Balance: KES 12.00</p>
                </div>
              </div>
            </div>
          </Panel>
