      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Button size="sm"><Plus className="mr-1.5 h-3.5 w-3.5" /> Provision AP</Button>
          </>
        }
      />
      <div className="p-6">
            ...
            <TableBody>
              {aps.map((n) => (
                <TableRow key={n.id} className="font-mono text-xs">
                  ...
                  <TableCell><div>{n.ip}</div><div className="text-[10px] text-muted-foreground">{n.mac}</div></TableCell>
                  ...
                  <TableCell className="text-right">{n.cpu}% / {n.memory}%</TableCell>
                  <TableCell>{n.firmware}</TableCell>
                  <TableCell><StatusDot status={n.status} /></TableCell>
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-1">
                      <Button size="icon" variant="ghost" className="h-7 w-7"><Settings2 className="h-3.5 w-3.5" /></Button>
